...
class Descriptions
{
    ...
    public static function getString($path, $type = 'name')
    {
        $descriptions = [
            ...
            'MaxDbList_cmt' => __('User cannot set a higher value'),
            ...
            'MaxTableList_cmt' => __('User cannot set a higher value'),
            ...
            'QueryHistoryMax_cmt' => __('User cannot set a higher value'),
            ...
            'Servers_users_name' => __('User table'),
