...
/**
 * set of common functions for sub tabs in server level `User` page
 *
 * @package PhpMyAdmin
 */
...
{
    /**
     * Get HTML for secondary level menu tabs on 'User' page
     *
     * @param string $selfUrl Url of the file
     *
     * @return string HTML for secondary level menu tabs on 'User' page
     */
